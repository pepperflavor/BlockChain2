...
const accounting_1 = new Department_1('Accounting');

console.log(accounting_1);

accounting_1.describe(); // accounting 이 출력된다.

// 그렇다면 다음코드의 출력 결과물은?
const accountingCopy = { describe : accounting_1.describe };
...
const accountingCopy_2 = { name : 'add-name',describe : accounting_1.describe };
