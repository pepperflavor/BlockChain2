...
/*
    블록체인의 무엇이 암호화폐로의 가치를 갖게 하는가?
    - 트랜잭션이다!
    암호화폐의 원리는 사용자들로 하여금 채굴자들이 채굴한 새로운 블록에 추가된 안전한 트랜잭션을 통해 새로운 블록에 트랜잭션을 발생시켜 암호화폐를 교환할 수 있도록한다.
    그리고 체인에 한번 등록된 블록은 해당 블록 내 어떠한 수정도 불가하다.
*/